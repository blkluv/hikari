...
A new SQL file for the posts has been added. If anyone from a previous version of HAHZ.LIVEwants to try it locally, they need to run [this](https://github.com/antoineross/hikari/blob/main/supabase/migrations/20240918141953_posts.sql) SQL file to set up the necessary database structure.
